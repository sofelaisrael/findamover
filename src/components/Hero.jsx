  ...
  return (
    <>
      ...
      <div className="h-[550px] max-md:h-[85vh] relative">
        ...
        >
          <div className="mt-10 h-full px-[150px] max-lg:px-[100px] max-md:px-[20px] bg-center bg-[url('./assets/moveboxes.webp')] bg-cover">
            ...
            <div className="herocontext h-full m text-center z-50 flex flex-col justify-center">
              <div className="heading text-[70px] w-full max-lg:text-[48px] max-lg:leading-[42px] leading-[65PX] text-white z-40 relative">
          ...
          <div className="justify-between grid grid-cols-5 items-center h-full px-[120px] bg-[#e8e8ea]  bg-[url('./assets/movechecklist.webp')] relative bg-cover bg-center max-lg:px-[80px] max-md:px-[20px]">
            ...
            <div className="herocontext col-span-3 h-full flex flex-col justify-center relative z-50 max-lg:col-span-4 max-md:col-span-full">
              <div className="heading text-[70px] leading-[65PX] text-white max-lg:text-[48px] max-lg:leading-[42px]">
                Quick, Easy and Free...
              </div>
          ...
          <div className="items-center h-full px-[150px] bg-[#e8e8ea] max-lg:px-[80px] max-md:px-[20px]">
            ...
            <div className="herocontext col-span-3 h-full flex flex-col justify-center">
              <div className="heading text-[70px] leading-[65PX] text-black text-right max-lg:text-[48px] max-lg:leading-[42px]">
                <div className="rev">
                  From <span className="text-[#fe5a50]">500+ </span> Google
                  Reviews
                </div>
              ...
              <div className="content text-[24px] max-lg:text-[18px] max-lg:leading-[16px] font-bold leading-[28px] text-black pt-5 text-right">
                Wuth an Average Google Reviews Ratung of{" "}
                <span className="text-[#fe5a50]">4.7 out of 5</span>
              </div>

              <div className="heading text-[70px] leading-[65PX] text-black mt-[10%] relative z-50 max-lg:text-[48px] max-lg:leading-[42px]">
                <div className="rev">
                  <span className="text-[#fe5a50]">140k+ </span> Moves Completed
                </div>
              </div>

              <div className="content  text-[24px] max-lg:text-[18px] max-lg:leading-[16px] font-bold leading-[28px] text-black  pt-5 relative z-50">
                Australia's <span className="text-[#fe5a50]">#1</span> place to
                find a mover
              </div>
