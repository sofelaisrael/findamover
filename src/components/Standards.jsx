...
const Standards = () => {
  return (
    <div className="grid grid-cols-2 px-20 gap-20 max-lg:grid-cols-1 max-md:px-10 max-sm:px-5 max-lg:gap-10">
      <div className="left flex-col flex gap-5">
        ...
        <div className="contbelow py-10">
          <span className="font-['quicksand'] text-[24px] leading-[20px] text-gray-500">
      ...
      <div className="right">
        <div className="title font-['quicksand'] text-[42px] leading-[40px] max-md:text-[32px] max-md:leading-[32px]">
